...
class NamingStrategy {
  ...
  static const Set<String> svKeywords = {
    ...
    'real', 'time', 'typedef', 'enum', 'struct', 'union', 'package', 'import',
    'export', 'parameter', 'localparam', 'always', 'always_ff', 'always_comb',
    'always_latch', 'assign', 'initial', 'begin', 'end', 'if', 'else',
    'case', 'endcase', 'default', 'for', 'while', 'repeat', 'foreach',
    'do', 'break', 'continue', 'return', 'function', 'endfunction', 'task',
    'endtask', 'class', 'endclass', 'extends', 'implements', 'super',
    'this', 'new', 'delete', 'const', 'final', 'static', 'private', 'public',
    'protected', 'virtual', 'pure', 'interface', 'endinterface', 'modport',
    'clocking', 'endclocking', 'property', 'endproperty', 'sequence',
    'endsequence', 'rand', 'randc', 'constraint', 'covergroup', 'endgroup',
    'coverpoint', 'cross', 'assert', 'assume', 'cover', 'expect', 'bind',
    'force', 'release', 'fork', 'join', 'join_any', 'join_none',
    'disable', 'semaphore', 'mailbox', 'process', 'ref', 'automatic',
    'static', 'program', 'endprogram', 'checker', 'endchecker',
  };
